...
* `oexp_separate_tags()`: separate the tags contained in the `other_tags` column. This is done by default with importing the data with `oexp_read()`
...
* [OSMscale](https://cran.r-project.org/web/packages/osmplotr) to plot spatial data with OSM basemaps and corresponding scalebars.
